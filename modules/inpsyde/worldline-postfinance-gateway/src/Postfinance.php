...
namespace Syde\Vendor\Cawl\Inpsyde\WorldlineForWoocommerce\PostfinanceGateway;
...
use Syde\Vendor\Cawl\Inpsyde\PaymentGateway\GatewayIconsRendererInterface;
use Syde\Vendor\Cawl\Inpsyde\PaymentGateway\Icon;
use Syde\Vendor\Cawl\Inpsyde\PaymentGateway\IconProviderInterface;
use Syde\Vendor\Cawl\Inpsyde\PaymentGateway\Method\DefaultPaymentMethodDefinitionTrait;
use Syde\Vendor\Cawl\Inpsyde\PaymentGateway\Method\PaymentMethodDefinition;
use Syde\Vendor\Cawl\Inpsyde\PaymentGateway\PaymentProcessorInterface;
use Syde\Vendor\Cawl\Inpsyde\PaymentGateway\PaymentRequestValidatorInterface;
...
class Postfinance implements PaymentMethodDefinition
{
    ...
    {
        return ['enabled' => ['title' => \__('Enable/Disable', 'cawl-for-woocommerce'), 'type' => 'checkbox', 'label' => \__('Enable PostFinance (CAWL)', 'cawl-for-woocommerce'), 'default' => 'no']];
    }
