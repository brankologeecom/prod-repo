...
namespace Syde\Vendor\Cawl\Inpsyde\WorldlineForWoocommerce\TwintGateway;
...
class TwintGatewayModule implements ServiceModule, ExtendingModule
{
    use ModuleClassNameIdTrait;
    public const PACKAGE_NAME = 'worldline-twint-gateway';
