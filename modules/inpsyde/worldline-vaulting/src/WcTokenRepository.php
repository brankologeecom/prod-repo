...
namespace Syde\Vendor\Cawl\Inpsyde\WorldlineForWoocommerce\Vaulting;

use Syde\Vendor\Cawl\OnlinePayments\Sdk\Domain\CardEssentials;
...
class WcTokenRepository
{
     ...
     * @param int $paymentProductId The CAWL payment product ID.
     */
